...
export const ReportContent: React.FC<ReportContentProps> = ({ data, originalPdfFile }) => (
     <div className="p-8 font-sans text-sm text-slate-800 bg-white">
        ...
        <div className="grid grid-cols-2 gap-8 mb-6">
            <div>
                <h3 className="font-bold text-slate-600 border-b pb-1 mb-2">Dobavljač</h3>
         ...
         <h3 className="font-bold text-slate-600 border-b pb-1 mb-2">Detalji Fakture</h3>
        ...
        <h3 className="font-bold text-slate-600 border-b pb-1 mb-2">Stavke</h3>
        ...
        <h3 className="font-bold text-slate-600 border-b pb-1 mb-2">Obračun PDV-a (Reverse Charge)</h3>
        <div className="bg-blue-50 p-4 rounded-lg">
             <div className="grid grid-cols-2 gap-x-4 gap-y-1">
                ...
                <p className="border-t border-slate-300 pt-2 mt-2">Ukupno s PDV-om:</p><p className="font-bold text-right border-t border-slate-300 pt-2 mt-2">{data.calculations.commission_total_with_vat.toFixed(2)} {data.invoice.currency}</p>
             </div>
             {data.calculations.notes && <p className="text-xs text-slate-500 mt-4"><em>Napomena: {data.calculations.notes}</em></p>}
        </div>
        
        <h3 className="font-bold text-slate-600 border-b pb-1 mt-6 mb-2">Upute za PDV Prijavu</h3>
        <p className="whitespace-pre-wrap bg-slate-100 p-4 rounded-lg text-slate-700 font-mono text-xs">{data.actions.instructions_for_pdv_form}</p>
