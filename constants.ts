...
1.  **STRIKTNO PREMA SHEMI:** Tvoj izlaz mora biti ISKLJUČIVO validan JSON objekt koji se u potpunosti pridržava zadane \`responseSchema\`. Ne dodaji nikakve dodatne komentare, objašnjenja ili markdown formatiranje izvan JSON-a.
...
5.  **METADATA:**
    ...
    *   \`parser_version\`: Postavi na "1.1-gemini-flash".
  ...
  properties: {
    ...
    buyer: {
      ...
      properties: {
        ...
        vat_id: { type: Type.STRING, description: 'Buyer\'s VAT identification number. Can be null if not present.' },
      },
